        ...
        <div className="text-center mb-12">
          <div className="glass-card max-w-4xl mx-auto float-animation">
            <div className="flex items-center justify-center mb-6">
              <div className="w-16 h-16 bg-gradient-to-br from-teal-600 to-cyan-600 rounded-2xl flex items-center justify-center mr-4">
                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                </svg>
              </div>
              <div className="text-left">
                <h1 className="text-5xl font-bold text-gradient-medical mb-2">
            ...
            <div className="bg-gradient-to-r from-teal-50 to-cyan-50 rounded-xl p-6 mb-6">
              <div className="flex items-center justify-center space-x-8">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-cyan-600">6,094</div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="medical-card hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-gray-800">Healthcare Portal</h3>
            </div>
          ...
          <div className="medical-card hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold text-gray-800">New Registration</h3>
            </div>
            <p className="text-gray-600 mb-6 leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="stat-card">
              <div className="flex items-center mb-3">
                ...
                <h4 className="font-bold text-gray-800">SVM Algorithm</h4>
              </div>
              <p className="text-sm text-gray-600">Support Vector Machine with 92.3% accuracy for complex pattern recognition</p>
            </div>
            ...
            <div className="stat-card">
              <div className="flex items-center mb-3">
                ...
                <h4 className="font-bold text-gray-800">Naive Bayes</h4>
              </div>
              <p className="text-sm text-gray-600">Probabilistic classifier with 89.7% accuracy for rapid predictions</p>
            </div>
            ...
            <div className="stat-card">
              <div className="flex items-center mb-3">
                ...
                <h4 className="font-bold text-gray-800">Decision Trees</h4>
              </div>
              <p className="text-sm text-gray-600">Interpretable model with 88.1% accuracy for clear decision paths</p>
            </div>

            <div className="stat-card">
              <div className="flex items-center mb-3">
                <div className="w-10 h-10 bg-gradient-to-br from-orange-500 to-yellow-600 rounded-lg flex items-center justify-center mr-3">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                  </svg>
                </div>
                <h4 className="font-bold text-gray-800">Ensemble ML</h4>
              </div>
              <p className="text-sm text-gray-600">Combined models for maximum accuracy and reliability in predictions</p>
            </div>
          </div>
        </div>
      </div>
