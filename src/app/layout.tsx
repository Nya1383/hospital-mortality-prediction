          ...
          <div className="container mx-auto px-4 py-3">
            <div className="flex justify-between items-center">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-gradient-medical">PERSONALIZED FEDERATED LEARNING</h1>
              ...
              <div className="md:hidden">
                <button className="p-2 rounded-lg hover:bg-white/20 transition-all duration-200">
